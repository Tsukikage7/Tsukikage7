<div align="center">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=30&pause=1000&color=0891B2&width=520&lines=Endless+improvement;Go+Backend+%7C+Distributed+Systems;Cloud+Native+Enthusiast;Love+clean+code" alt="Typing SVG" />
</div>
...
Hi there, I'm **Tsukikage** — a Golang Backend Engineer who loves building things that scale.

- CS graduate from **NUIST** (Nanjing University of Information Science & Technology)
- Backend Engineer **@UCloud**, focused on distributed systems & cloud infrastructure
- Passionate about high-performance services, microservices & cloud-native tooling
- Currently exploring: **eBPF · Service Mesh · Observability**
- 2026 goals: deepen cloud-native expertise · contribute to open source · write more tech notes
...
| 项目 | 介绍 | 技术栈 |
| :-- | :-- | :-- |
| **[servex](https://github.com/Tsukikage7/servex)** | 高性能 Go 服务框架，面向生产可用的微服务脚手架，内置服务治理能力 | `Go` `gRPC` `Microservices` |
| **[dubbo-go](https://github.com/Tsukikage7/dubbo-go)** | Apache Dubbo 的 Go 语言实现，参与分布式 RPC 框架的开发与贡献 | `Go` `RPC` `Distributed` |
| **[dubbo-go-pixiu](https://github.com/Tsukikage7/dubbo-go-pixiu)** | 云原生网关代理，打通外部 HTTP/gRPC 请求到内部 Dubbo 集群 | `Go` `Gateway` `Cloud Native` |
| **[akka-spark](https://github.com/Tsukikage7/akka-spark)** | 基于 Akka 框架构建的 Spark 通信基础设施，探索分布式计算通信层 | `Scala` `Akka` `Spark` |

---

<h2>Currently Working On</h2>

- 参与 **Dubbo-Go** 生态建设，优化 RPC 调用链路与 Triple 协议支持
- 在 **UCloud** 打磨分布式云服务的可观测性与稳定性
- 深入学习 **eBPF / Service Mesh / 分布式追踪** 相关底层原理
- 整理技术笔记，持续输出 Go 后端与云原生相关内容
